...
from clipscope.crawler.douyin.web.web_crawler import DouyinWebCrawler  # 导入抖音Web爬虫
from clipscope.crawler.tiktok.web.web_crawler import TikTokWebCrawler  # 导入TikTok Web爬虫
from clipscope.crawler.tiktok.app.app_crawler import TikTokAPPCrawler  # 导入TikTok App爬虫
from clipscope.crawler.bilibili.web.web_crawler import BilibiliWebCrawler  # 导入Bilibili Web爬虫
    ...
    async def hybrid_parsing_single_video(self, url: str, minimal: bool = False):
        ...
        if platform == "douyin":
            ...
            if url_type == "video":
                ...
                wm_video_url = (
                    f"https://aweme.snssdk.com/aweme/v1/playwm/?video_id={uri}&radio=1080p&line=0"
                )
            ...
            if url_type == "video":
                ...
                api_data = {
                    "video_data": {
                        ...
                        "nwm_video_url_HQ": data["video"]["bit_rate"][0]["play_addr"]["url_list"][
                            0
                        ],
                    }
                }
